...
torch::Tensor correlation_cuda_forward(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(input1.scalar_type(), "correlation_forward_cuda", ([&] {
...
std::vector<torch::Tensor> correlation_cuda_backward(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(input1.scalar_type(), "correlation_backward_cuda", ([&] {
