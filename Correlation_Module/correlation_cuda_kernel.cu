...
torch::Tensor correlation_cuda_forward(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND3(kFloat32, kBFloat16, kHalf, input1.scalar_type(), "correlation_forward_cuda", ([&] {
...
std::vector<torch::Tensor> correlation_cuda_backward(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND3(kFloat32, kBFloat16, kHalf, input1.scalar_type(), "correlation_backward_cuda", ([&] {
